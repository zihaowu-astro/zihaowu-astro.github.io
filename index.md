...
I am Zihao Wu (pronounced [Wú zǐháo](https://translate.google.com/?sl=auto&tl=en&text=%E5%90%B4%E6%A2%93%E8%B1%AA&op=translate)), a PhD student in the Department of Astronomy at Harvard University, advised by Professor [Daniel J. Eisenstein](https://scholar.harvard.edu/deisenstein/). I am a member of the [JWST Advanced Deep Extragalactic Survey (JADES)](https://jades-survey.github.io/).
...
I also develop advanced photometry method to study galaxies at z = 14. I build a forward-modeling photometric technique that provides accurate JWST/MIRI measurements for the most luminous known z = 14 galaxy, JADES-GS-z14-0, and the faintest known object, JADES-GS-z14-1. I lead a comprehensive NIRSpec, NIRCam, and MIRI study of JADES-GS-z14-1, using a total of 240 hours of JWST observations. Addtionally, I contributed to the JADES data reduction pipeline by developing a multi-component wisp template based on non-negative matrix factorization (NMF), which significantly improves the removal of wisp artifacts—one of the most challenging sources of contamination.

Outside of research, I enjoy long-distance cycling, hiking, playing guitar, and reading. I have biked over 2,000 km, including a 900 km journey across the Yunnan Plateau, serving as the rear support rider handling mechanical repairs. Born in Sichuan, I have always loved hotpot and spicy food.
